...
namespace Tracks
{
  public class TracksManager : MonoBehaviour
  {
    ...
    public Color standartFogColor;
    public Color secretFogColor;
    ...
    public IEnumerator Begin()
    {
      if (!_mRerun)
      {
        ...
        if (currentThemes.themeName == "Secret")
        {
          directionalLight.color = secretFogColor;
        }
    ...
    public void End()
    {
      ...
      directionalLight.color = standartFogColor;
