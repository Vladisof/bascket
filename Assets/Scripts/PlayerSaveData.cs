...
public class PlayerSaveData
{
  ...
  public string previousName = "John";
  ...
  public static void NewSave()
  {
    ...
    _mInstance.characters.Add("John");
  ...
  private void Read()
  {
    ...
    for (int i = 0; i < charCount; ++i)
    {
      ...
      if (charName.Contains("Steve") && ver < 11)
      {
        charName = charName.Replace("Steve", "Steve");
      }
...
public class PlayerDataEditor : Editor
{
  ...
  [MenuItem("Cheat/Give DeepLink")]
  public static void GiveDeepLink()
  {
    PlayerSaveData.instance.isDeepLinkActive = true;
    PlayerSaveData.instance.Save();
  }
